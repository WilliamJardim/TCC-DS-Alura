...
dataset_filtrado = dataset_completo.loc[ (dataset_completo['Mes'].isin([1, 2, 3])) & (dataset_completo['Ano'] == 2020) ]
...
plt.title('Evolução da Média do Crescimento da Soja (Janeiro a Março - 2020)', fontsize=14)
